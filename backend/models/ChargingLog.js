...
const ChargingLogSchema = new mongoose.Schema({
  ...
  startBattery: { type: Number, min: 0, max: 100 },
  targetBattery: { type: Number, min: 0, max: 100, default: 100 },
  expectedCompletionTime: { type: Date },
  actualCompletionTime: { type: Date },
  chargingPoint: { type: String, trim: true },
  status: { type: String, enum: ['CHARGING', 'COMPLETED', 'INTERRUPTED'], default: 'CHARGING' },
